    ...
    <view class="container">
      ...
      <view class="history_content" v-else>
        ...
        <uni-tag
          ...
          :customStyle="'display: inline-block;margin: 30rpx 30rpx 0 0;padding: 5px 10px;border-radius: 20px;background: #c00000; border-color: #c00000;box-shadow: .3rem .3rem .6rem #E4EBF5, -.2rem -.2rem .5rem #fff;'"
        ></uni-tag>
